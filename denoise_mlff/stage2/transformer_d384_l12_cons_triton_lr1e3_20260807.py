...
transformer_ft_attnres_wd02_20260621.
"""
        ...
        return dict(
            ...
            lr_scheduler=dict(
                ...
                params=dict(
                    name="exp_warmup",
                    params=dict(
                        # The reference uses 512 atoms x grad_accum 20. This
                        # run updates every 3,200 atoms, so scale step counts
                        # by 10,240 / 3,200 = 3.2 to preserve epoch timing.
                        warmup_steps=6_400,
                        decay_steps=128_000,
                        min_lr_ratio=0.01,
                    ),
