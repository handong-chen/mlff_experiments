"""Conservative EqMFT Stage-2 finetune from the running 256k-atom mean-field stage-1.

This is a continuation of the pure mean-field checkpoint with the conservative
