...
Four-layer weight-sharing blocks with 64-wide site/local features and
128-wide fields; the trunk still applies 24 layers.
...
# Stage-1 physical atom caps: 1,260 / 2,800 / 5,600 / 11,200 / 17,920.
...
STAGE1_CHECKPOINT = os.path.join(
    ...
    "denoise_mlff",
    "stage1",
    "eqmft_fourier_v3_sparse_tied4_site64_20260906",
