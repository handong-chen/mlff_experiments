"""Invariant bond-energy sibling of the compiled-field/history site-128 baseline.

Keeps the baseline's Stage-1 checkpoint and 50-epoch training configuration.
Requires the optional bond readout introduced in mlff:a2a3d77. Inherited physical
batch capacities have not been profiled with the additional bond head.
"""
