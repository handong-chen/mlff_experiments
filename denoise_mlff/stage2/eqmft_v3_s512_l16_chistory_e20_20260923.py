"""Site-512, 16-layer compiled-history Stage-2 with the earlier LR schedule.

Standalone sibling of eqmft_v3_s512_l16_chistory_e20_longlr_20260919.
Only the LR step schedule and output identity change: warmup 1153 steps
and decay 23066 steps, matching the previous compiled-history schedule in
eqmft_fourier_v3_sparse_site128_cons_e20_compiled_history_20260912.
Peak LR remains 3e-4 and the minimum LR ratio remains 0.01.

Preserves the epoch-20 initializer from eqmft_fourier_v3_sparse_site512_l16_20260917
at mlff=0cdb8f0;workshop=9afaf97, all model and execution settings, physical
batch budgets, the 16,000-atom logical batch, and 128 validation samples.
Compiled fields and analytical history are enabled; layer replay is not.
GPU budgets remain estimates, not measured or certified OOM-free fits.
"""
