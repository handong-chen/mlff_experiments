"""Conservative sparse Fourier-v3 Stage-2 finetune from Stage-1 epoch 20.

Untied 24-layer trunk with 32-wide site/local features and 128-wide fields.
The complete trunk is transferred, including local and Fourier refreshes at
...
MAX_ATOMS = 100
# The 506-atom conservative peak is 3.594 GiB versus 2.740 GiB for the
# matching Fourier-v2 Stage-2 control. At 80GB, use
# floor(12,000 * 2.740 / 3.594 / 16) * 16 = 9_136; lower tiers retain
...
STAGE1_CHECKPOINT = os.path.join(
    ...
    "denoise_mlff",
    "stage1",
    "eqmft_fourier_v3_sparse_20260905",
    "mlff=7860381;workshop=9afaf97",
    "epoch_000020.pt",
)
