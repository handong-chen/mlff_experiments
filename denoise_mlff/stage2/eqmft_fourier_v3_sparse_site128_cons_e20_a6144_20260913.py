"""Higher-physical-budget eager sibling of the untied site128 Stage-2 run.

Baseline: eqmft_fourier_v3_sparse_site128_cons_e20_20260910.
...
STAGE1_CHECKPOINT = os.path.join(
    ...
    "denoise_mlff",
    "stage1",
    "eqmft_fourier_v3_sparse_site128_20260908",
