"""Untied site-128 sparse Fourier-v3 Stage-2 finetune from epoch 20.

Sibling of eqmft_fourier_v3_sparse_tied4_site128_cons_e20_20260908. All 24
physical layers have independent parameters and load the corresponding
untied Stage-1 checkpoint, eqmft_fourier_v3_sparse_site128_20260908.
Site and field widths remain 128, radial/invariant MLP widths remain 512,
and the fresh invariant energy readout remains 256-wide. Local and Fourier
refreshes remain at layers 0, 4, 8, 12, 16, and 20.

Physical atom and validation caps retain the tied Stage-2 sibling estimates.
Independent layers add parameter, gradient, and optimizer-state storage;
these caps have not been measured for untied Stage-2 training. The logical
12,000-atom batch, 128-sample validation cap, conservative force/stress loss,
50-epoch duration, and optimization schedule follow the tied sibling.
"""
