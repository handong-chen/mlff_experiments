"""Conservative L12 Transformer finetune with stronger stress supervision.

This sibling keeps the 11,200-atom global batch and all model, optimizer, and
scheduler settings from the parent config. It increases only the stress loss
weight from 0.0125 to 0.125 so the conservative stress gradient has a material
optimizer-scale contribution alongside energy and force.
"""
