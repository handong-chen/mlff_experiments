"""Site-256, 24-layer conservative Stage-2 with compiled fields and history.

Standalone sibling of eqmft_v3_s128_chistory_e20_longlr_20260915.
Loads epoch 20 of eqmft_fourier_v3_sparse_site256_20260917
...
# 2 * (24 / 24) = 2. Fixed parameter/gradient/AdamW storage grows separately.
# The 80GB cap leaves room for that fixed-state increase and targets
# 4 physical calls for 16,000 atoms: 4 * (4160 - 99) >= 16,000.
...
STAGE1_CHECKPOINT = os.path.join(
    ...
    "denoise_mlff",
    "stage1",
    "eqmft_fourier_v3_sparse_site256_20260917",
            ...
            model=dict(
                ...
                params=dict(
                    config=dict(
                        ...
                        site_channels=(256, 256, 256),
                        field_channels=(128, 128, 128),
                        qk_channels=(8, 8, 8),
                        n_heads=4,
                        atom_embedding_dim=256,
                        n_rbf=32,
                        radial_hidden_dim=1024,
                        invariant_hidden_dim=1024,
                        attn_res_key_dim=64,
