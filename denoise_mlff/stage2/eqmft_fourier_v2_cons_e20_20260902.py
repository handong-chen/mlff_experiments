"""Conservative EqMFT Fourier-v2 Stage-2 finetune from Stage-1 epoch 20.

The Stage-1 checkpoint transfers the complete dynamic-Fourier-v2 trunk
exactly.  Stage 2 adds a fresh invariant energy readout; forces and stress are
derivatives of the summed physical energy.  The logical atom batch, loss,
optimizer, and schedule match the established 3e-4 mean-field conservative
control.  Physical subdivision is more conservative because the Fourier route
keeps its transported site history in float32 and conservative training needs
double backward.
"""
