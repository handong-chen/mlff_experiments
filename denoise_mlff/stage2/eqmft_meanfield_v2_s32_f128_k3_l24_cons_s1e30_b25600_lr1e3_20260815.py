...
# Calibrated from the same conservative force-and-stress path, and aggressively
# reduced for 7-8 GiB nodes to avoid first-batch CUDA OOM in conservative
# forward/backward.
REFERENCE_MICROBATCH_ATOMS = 256
