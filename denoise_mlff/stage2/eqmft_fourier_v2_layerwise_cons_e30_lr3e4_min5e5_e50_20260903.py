"""Lower-LR conservative layerwise Fourier-v2 finetune from Stage-1 epoch 30.
...
learning rate warms to 3e-4 over approximately half an epoch and exponentially
            ...
            lr_scheduler=dict(
                ...
                params=dict(
                    ...
                    params=dict(
                        ...
                        # constant places the 1/6 floor at approximately epoch 50
                        # for the 10,000-atom logical batch.
                        warmup_steps=1_967,
                        decay_steps=108_753,
                        min_lr_ratio=1.0 / 6.0,
                    ),
                    interval="step",
                ),
            ),
