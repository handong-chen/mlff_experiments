"""Compiled-field/history sibling with the original sparse-v3 LR schedule.

Preserves the model, epoch-20 initializer, optimizer, data, execution settings
and batch budgets of
eqmft_fourier_v3_sparse_site128_cons_e20_compiled_history_20260912.
That parent provider is unchanged. Copies exp_warmup step counts and minimum
LR ratio exactly from eqmft_fourier_v3_sparse_cons_e20_20260907, without
batch-size rescaling. Layer replay remains disabled.

Budget estimates include fixed-capacity field padding, not an A100 capacity test.
The logical optimizer batch remains 16,000 atoms.
"""
