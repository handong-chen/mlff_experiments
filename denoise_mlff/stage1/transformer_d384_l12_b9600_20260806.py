"""Stage-1 dense-transformer pretrain with a 9.6k-atom logical batch."""
...
class ConfigProvider:
    def __call__(self, *args, **kwargs):
        ...
        batch_plan = resolve_elastic_batch(
            ...
            # The round full-tier cap factorizes to exactly 500k on 40 GB GPUs.
            full_budget_pair_slots=1_000_000,
        )
