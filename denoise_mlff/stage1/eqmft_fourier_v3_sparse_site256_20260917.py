"""Untied site-256 sparse dynamic MF v3 Stage-1 experiment.

Sibling of eqmft_fourier_v3_sparse_site128_20260908. Site channels and
atom embedding/local-refresh projection width double to 256; radial and
invariant MLP widths double to 1024 and position readout width to 512.
...
class ConfigProvider:
    def __call__(self, *args, **kwargs):
        ...
        print(
            "[denoise-mlff][elastic-eqmft-fourier-v3-sparse-site256] "
            ...
            model=dict(
                ...
                params=dict(
                    config=dict(
                        ...
                        position_readout_hidden_dim=512,
