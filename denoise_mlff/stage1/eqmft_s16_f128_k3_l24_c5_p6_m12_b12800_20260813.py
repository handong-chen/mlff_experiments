"""Stage-1 EqMFT with three L=2 mean-field tokens and multiplicity training.
...
REFERENCE_MICROBATCH_ATOMS = 2_200
MICROBATCH_ATOM_GRANULARITY = 100
REFERENCE_MICROBATCH_EDGES = 126_000
            ...
            model=dict(
                ...
                params=dict(
                    config=dict(
                        ...
                        architecture_version="eqmft_denoiser_meanfield_v1",
