...
The logical optimizer batch is fixed at 25,600 atoms on every GPU so runs can
...
# Physical subdivision only; this config keeps all 25.6k logical atoms.
# Starting tier values are:
# under_12gb: 3k/120k, 12_to_23gb: 4k/160k, 24_to_39gb: 9k/360k,
# 40_to_79gb: 15k/600k, 80gb_plus: 40k/1_600k.
