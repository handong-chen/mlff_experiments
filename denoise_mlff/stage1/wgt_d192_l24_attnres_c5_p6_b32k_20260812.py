"""Stage-1 deep, narrow WGT with a fixed p=6 C2 envelope at rc=5 A.
...
The fixed envelope removes the previous learned per-layer envelope mixture.
"""
            ...
            model=dict(
                ...
                params=dict(
                    config=dict(
                        ...
                        attn_key_drop=0.0,
                        attn_res=True,
                        architecture_version="wgt_windowed_graph_transformer_v3",
