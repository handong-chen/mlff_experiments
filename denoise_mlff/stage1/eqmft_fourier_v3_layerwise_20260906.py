"""Layerwise dynamic MF v3 Stage-1 experiment.

Derived from eqmft_fourier_v3_sparse_20260905 with both local geometry and
Fourier refreshed at every zero-based layer, 0 through 23. Local geometry uses
the learned site scalars in the existing width256 geometry MLP. Local refresh
...
class ConfigProvider:
    def __call__(self, *args, **kwargs):
        ...
        print(
            "[denoise-mlff][elastic-eqmft-fourier-v3-layerwise] "
            ...
            model=dict(
                ...
                params=dict(
                    config=dict(
                        ...
                        dynamic_reciprocal_refresh_layers=tuple(range(24)),
                        dynamic_local_refresh_layers=tuple(range(24)),
