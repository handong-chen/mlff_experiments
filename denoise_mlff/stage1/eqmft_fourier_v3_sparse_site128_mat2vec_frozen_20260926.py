"""Fresh Stage-1 EqMFT with frozen 200D pretrained mat2vec inputs.

Follows eqmft_fourier_v3_sparse_site128_20260908: 24 untied layers with
128-channel site and field features and the same training settings. Only the
raw element input changes to frozen mat2vec vectors and its architecture ID.
No learned per-element vectors or projection; the surrounding network trains
from scratch. Batch budgets are inherited starting estimates; the wider input
features have not yet been GPU capacity-tested.
"""
